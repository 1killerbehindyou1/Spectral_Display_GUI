                                        ...
                                        const QPixmap* pix_map)
{
     ...
     * This ensures that the function operates on valid data and prevents
     * potential errors.
     */
     ...
     * This ensures that the entire circle is sampled based on the angular
     * resolution.
     */
     ...
     * This represents the distance from the transform center along the
     * horizontal axis.
     */
    for (int led_idx = 1; led_idx < no_pixels; ++led_idx)
    {
         ...
         * This point represents the position along the radius at the current
         * LED index.
         */
         ...
         * This rectangle is used for color interpolation from the source
         * pixmap.
         */
        const QRectF rect_f{
         ...
         * This represents the angle around the transform center for the current
         * LED index.
         */
        for (int ang_idx = 0; ang_idx < width; ++ang_idx)
        {
            ...
            /**
             * Rotate the sampling rectangle and interpolate color from source
             * pixmap. This step applies the transformation to the rectangle and
             * retrieves the corresponding color.
             */
            ...
            {
                /**
                 * Stop this ray when interpolation can no longer provide a
                 * valid color. This prevents further processing along this
                 * direction, optimizing performance.
                 */
                break;
            }
        }
